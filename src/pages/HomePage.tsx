          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-left">
              ...
              <p className="text-base sm:text-lg text-zinc-600 max-w-xl leading-relaxed">
                Premium Football Jerseys for fans who live the game. Bangladesh's premier destination for master-grade player issue kits, fan editions, retro legends, and bespoke heat-press customization.
              </p>
              ...
              <div className="pt-6 grid grid-cols-3 gap-4 border-t border-[#E5E5E3] text-xs">
                <div>
                  <p className="font-black text-[#1F2024] text-sm">100% MASTER</p>
                  <p className="text-[11px] text-zinc-500 font-medium">Grade 1:1 Authentic Quality</p>
                </div>
                <div>
                  <p className="font-black text-[#1F2024] text-sm">24-48H DHAKA</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-12">
          <div className="text-center max-w-2xl mx-auto space-y-2">
            ...
            <h2 className="font-display text-3xl sm:text-5xl font-black text-[#1F2024] uppercase tracking-tight">
              Why Football Fans Trust RAYVEN
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-8 rounded-3xl bg-[#F7F7F5] border border-[#E5E5E3] space-y-4 hover:border-[#6D35C8] transition-colors shadow-xs">
              ...
              <h3 className="font-display text-xl font-black text-[#1F2024] uppercase">
                100% Master-Grade Craftsmanship
              </h3>
              <p className="text-xs text-zinc-600 leading-relaxed">
                Breathable Dri-FIT ADV & HEAT.RDY weave, embossed team badges, silicone heat-press sponsor prints, and genuine official sleeve badges.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#F7F7F5] border border-[#E5E5E3] space-y-4 hover:border-[#6D35C8] transition-colors shadow-xs">
              ...
              <h3 className="font-display text-xl font-black text-[#1F2024] uppercase">
                Custom Name & Number Heat-Press
              </h3>
              <p className="text-xs text-zinc-600 leading-relaxed">
                Get your own name or your favorite superstar’s name (Vini Jr, Bellingham, Messi, Yamal, Saka) printed with official tournament fonts.
              </p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-[#F7F7F5] border border-[#E5E5E3] space-y-4 hover:border-[#6D35C8] transition-colors shadow-xs">
              ...
              <h3 className="font-display text-xl font-black text-[#1F2024] uppercase">
                24-48H Bangladesh Delivery
              </h3>
              <p className="text-xs text-zinc-600 leading-relaxed">
                Fast courier dispatch to all 64 districts in Bangladesh with Cash on Delivery and complete parcel inspection support.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="rounded-3xl bg-[#6D35C8] p-8 sm:p-14 text-white shadow-xl shadow-purple-900/20 flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="space-y-3 max-w-xl text-left">
              ...
              <p className="text-sm text-purple-100 font-medium">
                Choose your club kit, pick Player or Fan Edition, and customize with your name & number. Free delivery on orders over ৳3,000!
              </p>
            </div>
